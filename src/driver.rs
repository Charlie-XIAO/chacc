...
//!
//! Similar to gcc, chacc is a higher-level driver that manages the entire
//! compilation process, and cc1 is the actual **compiler proper** for C code.
//! The chacc compiler driver invokes cc1, [as], and [ld] properly.
//!
